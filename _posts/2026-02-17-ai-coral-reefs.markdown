...
>"This tool offers insight for managers with informtion to focus monitoring and response efforst where and when they are needed most. These early warnings can be used to trigger emergency actions, such as increasing monitoring or deploying intervention and supporting more proactive and locally tailored reef conservation."
